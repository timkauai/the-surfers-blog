...
const GolfTipsPage = ({ data }) => {
  ...
  return (
    <Layout>
      <SEO title="Home" />
      <h1 className="centered"> Catagory: Golf Tips </h1>{" "}
...
export default GolfTipsPage;

export const GolfTipsQuery = graphql`
  query GolfTips {
    allMarkdownRemark(
      filter: { frontmatter: { keyword: { eq: "Golf Tips" } } }
    ) {
      nodes {
        frontmatter {
          keyword
